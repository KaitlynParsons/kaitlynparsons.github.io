...
const experience: IGenericCardProps[] = [
    {
        ...
        location: 'Remote',
        description: 'Skills: Amazon Web Services (AWS) · AWS Lambda · Amazon S3 · Jest · TypeScript · Node.js · Angular'
    },
    {
    ...
    {
        headline: {title: 'Software Engineer | Technology', subtitle: 'Canstar · Full-time'},
    ...
    {
        headline: {title: 'Software Engineer | Commercial', subtitle: 'Canstar · Full-time'},
    ...
    {
        headline: {title: 'Junior Software Developer', subtitle: 'In The Code · Full-time'},
...
const Experience = () => {
  return (
    <div>
      <h3>Experience</h3>
      {experience.map((exp: IGenericCardProps, index: number) => (
        <GenericCard
          key={index}
